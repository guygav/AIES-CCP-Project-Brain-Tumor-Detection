...
# # st.write("Upload an MRI image, and the model will predict whether there is a tumor or not.")
...
# #         # Resize the image to the input size of the model (240x240)
...
# #         confidence = prediction[0][0] if result == "Tumor Detected" else 1 - prediction[0][0]
...
# model = create_model()
# model.load_weights("vgg19_model_03.weights.h5")
